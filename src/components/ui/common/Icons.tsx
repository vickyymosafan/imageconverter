...
// Action icons
export const PreviewIcon: React.FC<IconProps> = ({ className, size = 'md' }) => (
  <svg
    className={cn(iconSizes[size], className)}
    fill="none"
    stroke="currentColor"
...
export const RemoveIcon: React.FC<IconProps> = ({ className, size = 'md' }) => (
  <svg
    className={cn(iconSizes[size], className)}
    fill="currentColor"
    viewBox="0 0 20 20"
...
export const AddIcon: React.FC<IconProps> = ({ className, size = 'md' }) => (
  <svg
    className={cn(iconSizes[size], className)}
    fill="none"
    stroke="currentColor"
...
// Feature icons
export const QualityIcon: React.FC<IconProps> = ({ className, size = 'md' }) => (
  <svg
    className={cn(iconSizes[size], className)}
    fill="currentColor"
    viewBox="0 0 20 20"
...
export const BatchIcon: React.FC<IconProps> = ({ className, size = 'md' }) => (
  <svg
    className={cn(iconSizes[size], className)}
    fill="currentColor"
    viewBox="0 0 20 20"
...
// Empty state icons
export const EmptyFolderIcon: React.FC<IconProps> = ({ className, size = 'md' }) => (
  <svg
    className={cn(iconSizes[size], className)}
    fill="none"
    stroke="currentColor"
